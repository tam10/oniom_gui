...
public class Connection : MonoBehaviour {
	...
	//Graphics
	public Vector3 start { get {return atom0.transform.position;}}
	public Vector3 mid { get { return (start + end) * 0.5f; } }
	public Vector3 end { get { return atom1.transform.position; } }
	public Vector3 PointAlong(float ratio) {
		return start * ratio + end * (1f - ratio);
	}
	public Color color0 { get { return atom0.color; } }
	public Color color1 { get { return atom1.color; } }
